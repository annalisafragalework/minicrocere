            ...
            <div class="card">
                ...
                <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="codefiscal" type="text" class="form-control @error('codefiscal') is-invalid @enderror" name="codefiscal" value="{{ old('codefiscal') }}" required autocomplete="codefiscal" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                @enderror
                                  ...
                                  <div class="row mb-3">
                            <label for="photo" class="col-md-4 col-form-label text-md-end">{{ __('Telefono') }}</label>
