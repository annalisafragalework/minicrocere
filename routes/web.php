...
Route::post('/register/activate-trial', [RegisterController::class, 'activateTrial'])
    ->name('register.activate-trial'); 
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::resource('admin/dottori.pazienti', PazienteController::class)
    ...
    Route::get('admin/dottori/{dottore}/pazienti-lista', [PazienteController::class, 'pazientiDelDottore'])
